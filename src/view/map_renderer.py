...
class MapRenderer:
    ...
    def render_controls(self):
        for i, line in enumerate(utils.GAMEPLAY_LOGO):
            self.controls_window.addstr(i + 1, 0, line, curses.color_pair(22) | curses.A_BOLD)
        ...
        self.controls_window.addstr(36, 7, "ROGUE 1980", curses.A_BOLD)
    ...
    def __init_colors() -> None:
        ...
        curses.init_pair(5, curses.COLOR_MAGENTA, curses.COLOR_BLACK)  # Границы
        curses.init_pair(6, curses.COLOR_WHITE, 241)  # 241 Коридоры
        curses.init_pair(7, curses.COLOR_BLACK, 84)  # Выход
        curses.init_pair(8, curses.COLOR_CYAN, curses.COLOR_WHITE)  # предметы
        ...
        curses.init_pair(23, curses.COLOR_BLUE, curses.COLOR_CYAN)  # Controls authors 
        ...
        #curses.init_pair(31, 110, curses.COLOR_BLACK)  # Коридоры
        curses.init_pair(30, 100, curses.COLOR_BLACK)  # стены
    ...
    def render_game_info(self, game_info: GameInfo):
        ...
        text_style = curses.A_BOLD | curses.color_pair(1)
